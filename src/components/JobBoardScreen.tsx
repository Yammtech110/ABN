      ...
      <div className="space-y-5 min-h-full bg-[#1E1915] px-4 pt-4 pb-8" id="job-detail-view">
        ...
        <div className="p-5 rounded-3xl bg-[#171310] border border-[#2B231D] space-y-5">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-3.5 bg-[#FF9E47] hover:bg-opacity-95 text-white font-extrabold rounded-2xl text-sm transition-all shadow-lg active:scale-95 no-underline"
          ...
          {filteredJobs.map((job) => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <ChevronRight className="w-3.5 h-3.5 text-gray-600 group-hover:text-[#F08C32] transition-colors flex-shrink-0 mt-0.5" />
              </div>
