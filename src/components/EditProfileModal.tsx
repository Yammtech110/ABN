      ...
      {isListingOwner ? (
        <form onSubmit={handleSaveListing} className="space-y-4 p-5 rounded-2xl bg-[#171310] border border-[#2B231D]">
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full py-3 rounded-xl bg-[#FF9E47] hover:bg-opacity-95 text-white font-extrabold text-xs transition-all flex items-center justify-center gap-2 disabled:opacity-50"
        ...
        <div className="p-5 rounded-2xl bg-[#171310] border border-[#2B231D] space-y-3" id="edit-profile-change-password">
          ...
          >
            ...
            <span className="text-[10px] font-bold text-[#F08C32]">
          ...
          {showChangePassword && (
            <form onSubmit={handleChangePassword} className="space-y-3 pt-1 border-t border-[#2B231D]">
              ...
              <button
                type="submit"
                disabled={pwBusy}
                className="w-full py-3 rounded-xl border border-[#F08C32]/50 bg-[#FF9E47]/15 hover:bg-[#FF9E47]/25 text-[#F08C32] font-extrabold text-xs transition-all flex items-center justify-center gap-2 disabled:opacity-50"
