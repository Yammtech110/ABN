      ...
      {!myBusiness || isManageForm ? (
        ...
        <div className="space-y-4 animate-fade-in" id="portal-registration-form-section">
          ...
          <form onSubmit={isManageForm ? handleManageSubmit : handleRegisterSubmit} className="space-y-4 p-5 rounded-3xl bg-[#13110E] border border-[#2D2319]" id={registrationType === 'service' ? 'service-reg-form' : 'biz-reg-form'}>
            ...
            {isManageForm && (
              <div className="p-4 rounded-2xl bg-[#1C130D]/80 border border-amber-900/40 space-y-3" id="listing-change-request-panel">
                ...
                {pendingChangeRequest?.status === 'pending' && (
                  <p className="text-[10px] font-bold text-[#FFA048] bg-black/30 rounded-xl px-3 py-2 border border-[#2D2319]">
                    {language === 'en'
                ...
                {pendingChangeRequest?.status !== 'pending' && (
                  <>
                    <button
                      ...
                      className="w-full py-2.5 rounded-xl border border-[#FFA048]/40 bg-[#FFA048]/10 hover:bg-[#FFA048]/20 text-[#FFA048] text-[10px] font-extrabold uppercase tracking-wider transition-all"
                    ...
                    {showChangeRequest && (
                      <div className="space-y-3 pt-1 border-t border-[#2D2319]" id="change-request-form">
                        <div>
                        ...
                        <button
                          ...
                          className="w-full py-2.5 rounded-xl bg-[#FFA048] text-black text-[10px] font-extrabold uppercase tracking-wider disabled:opacity-50"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={editName}
                      readOnly
                      className="w-full p-2.5 rounded-xl bg-[#0F0E0C] border border-[#2D2319] text-xs text-[#F4E3D7] opacity-80 cursor-not-allowed pr-9"
                      required
                    />
                    <Lock className="absolute right-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-amber-500/80" />
                  </div>
