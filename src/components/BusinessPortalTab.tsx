          ...
          <div className="space-y-4 animate-fade-in-up" id="portal-registration-selection">
            ...
            <div className="grid grid-cols-1 gap-4 mt-4">
              ...
              <button
                ...
                className="p-5 rounded-3xl bg-white border border-[#D7E0EA] hover:border-blue-500 transition-all flex flex-col text-left space-y-2 group shadow-sm active:scale-95"
              >
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-3 mb-2">
